...
| `ROON_WISHLIST_QOBUZ_COUNTRY` | Detected from host locale, otherwise `FI` | Two-letter ISO country code used for Qobuz catalog searches and links. It can also be changed later in Settings. |
