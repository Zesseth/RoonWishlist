...
echo "   cat $INSTALL_DIR/TESTING_USER.md"
echo ""
...
echo "   • TESTING_USER.md ........... Manual/feature testing guide"
echo "   • TESTING_TECH.md ........... Automated and API-level testing"
echo "   • ROON_API_LIMITATIONS.md ... API constraints"
echo ""
echo "   Issue tracking lives on GitHub:"
