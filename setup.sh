...
echo "📋 Next Steps:"
echo ""
echo "1️⃣  Read the project overview:"
...
echo "   • docs/DEVELOPMENT.md ............ Running it, tests, environment variables"
echo "   • docs/ROON_API_LIMITATIONS.md ... API constraints"
echo ""
echo "   Issue tracking and manual test checklists live on GitHub:"
echo "   https://github.com/Zesseth/RoonWishlist/issues"
echo ""
